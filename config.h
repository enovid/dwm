...
static const char *fonts[]          = { "monospace:size=12", "JoyPixels:pixelsize=8:antialias=true:autohint=true"  };
...
const char *spcmd1[] = {"kitty", "--name", "spterm", "--listen-on", "unix:/tmp/mykitty", NULL};
